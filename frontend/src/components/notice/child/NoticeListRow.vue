  ...
  <div class="container">
    <div class="card-media">
      ...
      <div class="card-media-object-container">
        <img :src="notice_img_url" alt="" class="card-media-object">
        <!-- <div
          ...
          "
        ></div> -->
        <span class="card-media-object-tag subtle">NEW!</span>
      </div>
      <!-- body container -->
      <div class="card-media-body">
        <div class="card-media-body-top">
          <span class="subtle">{{ notice_date }}</span>
        ...
        <span class="card-media-body-heading"
          ><h4><router-link
        :to="{ name: 'NoticeView', params: { notice_id: notice_id } }"
