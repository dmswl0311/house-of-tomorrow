...
//	Swagger 설정 확인
//	http://localhost:8080/happyhouse/v2/api-docs
//	Swagger-UI 확인
//	http://localhost:8080/happyhouse/swagger-ui.html
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title(title)
				.description("<h3>HappyHouse API Reference for Developers</h3>Swagger를 이용한 HappyHouse API<br>") 
				.contact(new Contact("광주 5반 박소진, 조은지", "https://edu.ssafy.com", "ssafy@ssafy.com"))
